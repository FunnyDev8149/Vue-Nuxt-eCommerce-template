<template>
	<header
		class="header"
		:class="{'header-border': !headerBorderRemoveList.includes($route.name)}"
	>
		<div class="header-top">
			<div class="container">
				<div class="header-left">
					<p class="welcome-msg">Welcome to Funny store message or remove it!</p>
				</div>
				<div class="header-right">
					...
					<nuxt-link
						to="/pages/contact-us"
						class="contact d-lg-show"
					><i class="d-icon-map"></i>Contact</nuxt-link>
					<a
						href="javascript:;"
						class="help d-lg-show"
		...
		<div class="header-bottom d-lg-show">
			<div class="container">
				...
				<div class="header-right">
					<a href="javascript:;"><i class="d-icon-card"></i>Special Offers</a>
					<a
						href="https://funny.com/buynow/Funnyvue"
						target="_blank"
						rel="noopener"
						class="ml-6"
					>Buy Funny!</a>
...
export default {
	...
	data: function () {
		return {
			headerBorderRemoveList: headerBorderRemoveList
		};
	},
	methods: {
