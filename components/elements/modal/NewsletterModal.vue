<template>
	...
	>
		<div class="newsletter-content">
			...
			<h2 class="font-weight-semi-bold">Sign up to <span>Funny</span></h2>
			<p class="text-grey">Subscribe to the Funny eCommerce newsletter to receive timely updates from your favorite products.</p>
			<form
				action="#"
				method="get"
